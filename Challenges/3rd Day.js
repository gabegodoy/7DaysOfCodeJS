...
function newTecnologies(){
    ...
    if (futureChoice == 'none'){
        ...
        noText.innerHTML = 'Great option! So then you can focus and specialize yourself more and more! <br><br> <strong>I have created a list of languages and courses focused on your profile, would you like to see that?</strong>'
        document.querySelector('.nextPage').style.display = 'block';
        noText.style.color = ('green');
    }

    else if (futureChoice == 'fullstack'){
        noText.innerHTML = 'Oh yeah! It is far away from being easy, but it definitely pays well! <br><br> <strong>I have created a list of languages and courses focused on your profile, would you like to see that?</strong>'
        document.querySelector('.nextPage').style.display = 'block';
        noText.style.color = ('green');
    }
